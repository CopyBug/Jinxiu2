...
public final class SplashActivity extends MyActivity
    ...
    public void hasPermission(List<String> granted, boolean isAll) {
        String jinxiuPhone = Until.GetShareP(getActivity(), "JinxiuPhone");
        String jinxiuPassword = Until.GetShareP(getActivity(), "JinxiuPassword");
        if(jinxiuPassword!=null&&jinxiuPhone!=null){
            if(jinxiuPhone.length()==11){
                //全局变量
                UserInfo.Phone=jinxiuPhone;
                UserInfo.Password=jinxiuPassword;
